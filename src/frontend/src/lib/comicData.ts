...
// Global counter ensures no two panels ever reuse the same image back-to-back
let _panelImgCounter = 0;
const getPanelIllustration = (_index?: number): string => {
  // Prime step (7) visits all 19 images before cycling, preventing adjacent duplicates
  const panelNumber = ((_panelImgCounter++ * 7) % 19) + 1;
...
export const COMIC_CHAPTERS: Chapter[] = [
    ...
    panels: [
      {
        ...
        timestampEnd: 15,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-01.dim_1024x768.png",
        illustrationAlt:
          "Miles Morales, a Black teenager with curly hair, standing in Brooklyn with cityscape behind him in bold comic style",
        parts: [
          {
            type: "caption",
      ...
      },
      {
        ...
        timestampEnd: 35,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-02.dim_1024x768.png",
        illustrationAlt:
          "Miles Morales with his father Jefferson in their apartment",
        parts: [
          { type: "scene", text: "Miles' apartment - Morning" },
          {
            type: "caption",
            text: "I'm 16 years old, and for the last week, my life has been weird.",
          },
          {
            type: "dialogue",
            speaker: "Jefferson",
            text: "You're going to be late! This school is important!",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "I know, Dad… I just need space.",
          },
        ],
      },
      {
        ...
        timestampEnd: 50,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-03.dim_1024x768.png",
        illustrationAlt: "Miles and Jefferson having a conversation",
        parts: [
          {
            type: "dialogue",
            speaker: "Jefferson",
            text: "Space? You got a whole room!",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "He doesn't get it. Nobody does.",
          },
        ],
      },
      {
        ...
        timestampEnd: 70,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-04.dim_1024x768.png",
        illustrationAlt:
          "Uncle Aaron's cozy apartment with graffiti art on walls",
        parts: [
          { type: "caption", text: "Later, at Uncle Aaron's place" },
          {
            type: "dialogue",
            speaker: "Aaron",
            text: "You don't have to be what everyone expects. Be yourself.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Thanks, Uncle Aaron. You always know what to say.",
          },
        ],
      },
      {
        ...
        timestampEnd: 90,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-05.dim_1024x768.png",
        illustrationAlt: "Abandoned subway tunnel at night",
        parts: [
          { type: "scene", text: "Abandoned subway tunnel - Night" },
          {
            type: "caption",
            text: "Miles sneaks into the tunnels to practice his art.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "This is my spot. Where I can be me.",
          },
        ],
      },
      {
        ...
        timestampEnd: 105,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-06.dim_1024x768.png",
        illustrationAlt: "Dark subway tunnel with a tiny radioactive spider",
        parts: [
          {
            type: "caption",
            text: "A tiny, camouflaged spider—barely visible—drops from above.",
          },
          { type: "sfx", text: "BITE!" },
      ...
      },
      {
        ...
        timestampEnd: 125,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-07.dim_1024x768.png",
        ...
        parts: [
          { type: "caption", text: "The next morning..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "My hand... it's sticking to everything!",
          },
          { type: "sfx", text: "STICK!" },
        ],
      },
      {
        ...
        timestampEnd: 145,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-08.dim_1024x768.png",
        ...
        parts: [
          { type: "scene", text: "Brooklyn Visions Academy" },
          {
            type: "dialogue",
            speaker: "Teacher",
            text: "Miles? Are you paying attention?",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "I can't unstick my hand from this desk!",
          },
        ],
      },
      {
        ...
        timestampEnd: 165,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-09.dim_1024x768.png",
        ...
        parts: [
          { type: "caption", text: "In the hallway..." },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "Hey, you're Miles, right? I'm Gwen.",
          },
          { type: "dialogue", speaker: "Miles", text: "Uh... yeah. Hi." },
          {
            type: "thought",
            speaker: "Miles",
            text: "Why is my heart racing?",
          },
        ],
      },
      {
        ...
        timestampEnd: 185,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-10.dim_1024x768.png",
        ...
        parts: [
          { type: "sfx", text: "STICK!" },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "Ow! Your hand is in my hair!",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "I'm so sorry! I don't know what's happening!",
          },
        ],
      },
      {
        ...
        timestampEnd: 205,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-11.dim_1024x768.png",
        ...
        parts: [
          { type: "caption", text: "After school..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "I need to go back to that tunnel. Find out what bit me.",
          },
      ...
      },
      {
        ...
        timestampEnd: 225,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-12.dim_1024x768.png",
        ...
        parts: [
          ...
          { type: "sfx", text: "CRASH! BOOM!" },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "What the—? Is that Spider-Man?!",
          },
        ],
      },
      {
        ...
        timestampEnd: 245,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-13.dim_1024x768.png",
        illustrationAlt:
          "Spider-Man fighting Green Goblin near a massive machine",
        parts: [
          {
            type: "dialogue",
            speaker: "Spider-Man",
            text: "You can't do this, Kingpin! The collider will destroy the city!",
          },
          {
            type: "dialogue",
            speaker: "Green Goblin",
            text: "Kingpin doesn't care about your city!",
          },
      ...
      },
      {
        ...
        timestampEnd: 265,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-14.dim_1024x768.png",
      ...
      },
      {
        ...
        timestampEnd: 285,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-15.dim_1024x768.png",
        illustrationAlt: "Spider-Man injured, talking to Miles",
        parts: [
          {
            type: "dialogue",
            speaker: "Spider-Man",
            text: "Kid... you gotta turn it off. Use this...",
          },
          { type: "dialogue", speaker: "Miles", text: "Me? But I'm not—" },
          {
            type: "dialogue",
            speaker: "Spider-Man",
            text: "You're like me. I can tell. You have powers.",
          },
        ],
      },
      {
        ...
        timestampEnd: 305,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-16.dim_1024x768.png",
        illustrationAlt: "Spider-Man giving Miles a USB drive",
        parts: [
          {
            type: "dialogue",
            speaker: "Spider-Man",
            text: "Take this override key. Destroy the collider.",
          },
          { type: "sfx", text: "CLICK!" },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Wait, I don't understand—",
          },
        ],
      },
      {
        ...
        timestampEnd: 325,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-17.dim_1024x768.png",
        ...
        parts: [
          { type: "caption", text: "A massive shadow looms..." },
          {
            type: "dialogue",
            speaker: "Kingpin",
            text: "Spider-Man. Always in my way.",
          },
      ...
      },
      {
        ...
        timestampEnd: 345,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-18.dim_1024x768.png",
        illustrationAlt: "Spider-Man fighting Kingpin",
        parts: [
          {
            type: "dialogue",
            speaker: "Spider-Man",
            text: "Run, kid! Get out of here!",
          },
          { type: "sfx", text: "WHAM!" },
          {
            type: "thought",
            speaker: "Miles",
            text: "I... I can't move. I'm frozen.",
          },
        ],
      },
      {
        ...
        timestampEnd: 365,
        illustrationSrc:
          "/assets/generated/spiderverse-panel-19.dim_1024x768.png",
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Spider-Man",
            text: "It's up to you now, kid...",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "No, no, no! Stay with me!",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "Miles runs..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "This can't be real. Spider-Man is dead.",
          },
          { type: "sfx", text: "WHOOSH!" },
        ],
      },
      {
        ...
        parts: [
          { type: "scene", text: "Miles' room - Late night" },
          {
            type: "thought",
            speaker: "Miles",
            text: "He said I have powers. Like him.",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "The next day..." },
          {
            type: "dialogue",
            speaker: "News Anchor",
            text: "Spider-Man is dead. New York mourns its hero.",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "Everyone loved him. And I just... watched.",
          },
        ],
      },
      {
        ...
        parts: [
          ...
          {
            type: "caption",
            text: "Thousands gather to honor the fallen hero.",
          },
          {
            type: "dialogue",
            speaker: "Citizen",
            text: "He saved us so many times...",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "Hey, Miles. Pretty crazy, huh?",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Yeah... I can't believe he's gone.",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "Later that night..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "What's happening to me now?!",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "Miles experiments with his powers..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "I can stick to walls. Turn invisible. But I'm not Spider-Man.",
          },
        ...
        parts: [
          {
            type: "thought",
            speaker: "Miles",
            text: "Spider-Man could swing. Maybe I can too?",
          },
          { type: "sfx", text: "THWIP!" },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Wait, I don't have web shooters!",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "sfx", text: "CRASH!" },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Ow... okay, not ready for that yet.",
          },
          {
            type: "caption",
            text: "Learning to be Spider-Man is harder than it looks...",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "scene", text: "Back to the tunnel" },
          {
            type: "thought",
            speaker: "Miles",
            text: "I have to destroy that machine. Like Spider-Man asked.",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Spider-Man?! But you're... you're dead!",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Dead? No, just... divorced and broke.",
          },
          { type: "sfx", text: "THUD!" },
        ],
      },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "You're like me, aren't you? Spider powers?",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Yeah, but I don't know how to use them!",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Don't worry, kid. I'll teach you.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "That collider opened portals to other dimensions.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Other dimensions? Like parallel universes?",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Exactly. And I got pulled into yours.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Spider-Man gave me this. Said to destroy the collider.",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Good. Because if we don't, I'll glitch out and die here.",
          },
      ...
      },
      {
        ...
        parts: [
          ...
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "My atoms... they don't belong here...",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "We need to get back to that collider. Fast.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "But Kingpin's guards are everywhere!",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Then we'll need a plan. And maybe some help.",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "caption", text: "Training montage begins..." },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Okay, kid. Show me what you got.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "I... I can't control it!",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Just relax. Feel the rhythm.",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "It's not about being perfect. It's about getting back up.",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "Maybe he's right. Maybe I can do this.",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "scene", text: "Miles' apartment - Evening" },
          {
            type: "dialogue",
            speaker: "Rio",
            text: "Miles, you've been acting strange. Is everything okay?",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Yeah, Mom. Just... school stuff.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Jefferson",
            text: "Son, I know things are tough. But we're here for you.",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "If only I could tell them the truth...",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "caption", text: "Later that night..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "I have to meet Peter. We have work to do.",
          },
          { type: "sfx", text: "SNEAK!" },
        ],
      },
      {
        ...
        parts: [
          { type: "scene", text: "Brooklyn rooftop" },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Alright, let's try the web-swinging again.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Do I have to? Last time hurt.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Trust yourself. You got this!",
          },
          { type: "sfx", text: "THWIP!" },
      ...
      },
      {
        ...
        parts: [
          { type: "sfx", text: "CRASH! BOOM!" },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Ow... still not ready.",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Progress! You lasted three seconds longer.",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "caption", text: "Suddenly..." },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "You guys need some help?",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Gwen?! You're... Spider-Woman?!",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "From another dimension. The collider pulled me here too.",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Great! Another Spider-Person. We could use the backup.",
          },
        ],
      },
    ],
    ...
    panels: [
      {
        ...
        parts: [
          ...
          { type: "dialogue", speaker: "Gwen", text: "So, what's the plan?" },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "We need to get to Kingpin's lab and shut down the collider.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Miles",
            text: "But I can barely control my powers!",
          },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "You'll learn. We all did.",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Noir",
            text: "Where am I? This place is too... colorful.",
          },
          { type: "dialogue", speaker: "Miles", text: "Another Spider-Man?!" },
          {
            type: "dialogue",
            speaker: "Noir",
            text: "Spider-Man Noir. From 1933.",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "sfx", text: "WHOOSH!" },
          {
            type: "dialogue",
            speaker: "Peni",
            text: "Konnichiwa! I'm Peni Parker, and this is SP//dr!",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "sfx", text: "BOING!" },
          {
            type: "dialogue",
            speaker: "Ham",
            text: "That's all, folks! Wait, wrong franchise. I'm Spider-Ham!",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "A cartoon pig. Of course.",
          },
        ],
      },
      {
        ...
        parts: [
          ...
          { type: "dialogue", speaker: "Miles", text: "This is insane!" },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "Welcome to the Spider-Verse, Miles.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Okay, everyone. Here's what we know about Kingpin...",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Noir",
            text: "In my dimension, we handle things with fists and shadows.",
          },
          {
            type: "dialogue",
            speaker: "Ham",
            text: "In mine, we use cartoon physics!",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "How is this my life now?",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "dialogue", speaker: "Gwen", text: "Miles, you okay?" },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Yeah, just... overwhelmed.",
          },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "You're not alone anymore. We're a team.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Alright, Spider-People. Let's do this!",
          },
      ...
      },
      {
        ...
        parts: [
          {
            type: "caption",
            text: "The Spider-Team swings through Brooklyn...",
          },
        ...
        parts: [
          {
            type: "thought",
            speaker: "Miles",
            text: "They make it look so easy...",
          },
          { type: "sfx", text: "THWIP! SWING!" },
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "You're doing great, Miles!",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peni",
            text: "SP//dr, engage combat mode!",
          },
          { type: "sfx", text: "BEEP BOOP! SMASH!" },
          {
            type: "caption",
            text: "The robot spider makes quick work of the guards...",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Noir",
            text: "In the shadows, I am justice.",
          },
        ...
        parts: [
          {
            type: "thought",
            speaker: "Miles",
            text: "They're amazing. Like a real team.",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Miles! A little help here!",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "There's the control panel.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "I have the override key!",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Good. Let's end this.",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "Kingpin's elite squad arrives..." },
          {
            type: "dialogue",
            speaker: "Prowler",
            text: "Going somewhere, Spider-Man?",
          },
          { type: "sfx", text: "THUD! THUD! THUD!" },
        ],
      },
      {
        ...
        parts: [
          ...
          { type: "caption", text: "The masked villain steps forward..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "Something about him seems familiar...",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Doc Ock",
            text: "You're not shutting down my collider!",
          },
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "Doc Ock? But you're—",
          },
          {
            type: "dialogue",
            speaker: "Doc Ock",
            text: "A woman? Yes. Problem?",
          },
        ],
      },
      {
        ...
        parts: [
          ...
          { type: "dialogue", speaker: "Tombstone", text: "..." },
          {
            type: "dialogue",
            speaker: "Scorpion",
            text: "Time to squash some spiders!",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "Your tentacles don't scare me!",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Noir",
            text: "I've faced tougher in the shadows.",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Ham",
            text: "Hey, Scorpy! Want some ham?",
          },
          {
            type: "dialogue",
            speaker: "Scorpion",
            text: "I'll crush you, pig!",
          },
      ...
      },
      {
        ...
        parts: [
          ...
          {
            type: "caption",
            text: "The robot spider fights with precision...",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "Miles confronts the Prowler..." },
          {
            type: "dialogue",
            speaker: "Prowler",
            text: "You're just a kid. Go home.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "I can't. I have to stop this!",
          },
        ],
      },
      {
        ...
        parts: [
          ...
          { type: "dialogue", speaker: "Miles", text: "You're fast!" },
          {
            type: "thought",
            speaker: "Miles",
            text: "His moves... they're so familiar...",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        parts: [
          { type: "sfx", text: "SHIMMER!" },
          {
            type: "dialogue",
            speaker: "Prowler",
            text: "What? Where did you go?!",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "It worked! I'm invisible!",
          },
        ],
      },
      {
        ...
        parts: [
          { type: "caption", text: "Miles uses his invisibility..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "I need to get to the controls!",
          },
          { type: "sfx", text: "SNEAK!" },
        ],
      },
      {
        ...
        parts: [
          {
            type: "caption",
            text: "In the chaos, the Prowler's mask cracks...",
          },
          { type: "sfx", text: "CRACK!" },
      ...
      },
      {
        ...
        parts: [
          { type: "dialogue", speaker: "Miles", text: "Uncle Aaron?!" },
          {
            type: "dialogue",
            speaker: "Aaron",
            text: "Miles... you're the Spider-Man?",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Miles",
            text: "You're the Prowler? Why?!",
          },
          {
            type: "dialogue",
            speaker: "Aaron",
            text: "I... I didn't know it was you, kid.",
          },
          {
            type: "thought",
            speaker: "Miles",
            text: "Everything I believed... was a lie.",
          },
        ],
      },
      {
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Aaron",
            text: "He's just a kid, Fisk!",
          },
          {
            type: "dialogue",
            speaker: "Kingpin",
            text: "Then you're no use to me.",
          },
          { type: "sfx", text: "BLAST!" },
        ],
      },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Aaron",
            text: "Miles... keep going. You're the best of us...",
          },
      ...
      },
      {
        ...
        parts: [
          { type: "caption", text: "Something changes in Miles..." },
          {
            type: "thought",
            speaker: "Miles",
            text: "No more running. No more fear.",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Miles",
            text: "You want Spider-Man? You got him!",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "That's it, Miles! Show them!",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "The portals are opening! Everyone, go!",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Peter B.",
            text: "You're gonna be a great Spider-Man, Miles.",
          },
          {
            type: "dialogue",
            speaker: "Miles",
            text: "Thanks for everything, Peter.",
          },
        ...
        parts: [
          {
            type: "dialogue",
            speaker: "Gwen",
            text: "I'll find a way back. I promise.",
          },
  ...
  },
  {
    ...
    panels: Array.from({ length: 80 }, (_, i) => ({
      ...
      parts: [{ type: "caption" as const, text: `Chapter 3, Panel ${i + 1}` }],
    })),
  },
  {
    id: "ch4",
    ...
    panels: Array.from({ length: 80 }, (_, i) => ({
      ...
      parts: [{ type: "caption" as const, text: `Chapter 4, Panel ${i + 1}` }],
    })),
  },
  {
    id: "ch5",
    ...
    panels: Array.from({ length: 80 }, (_, i) => ({
      ...
      parts: [{ type: "caption" as const, text: `Chapter 5, Panel ${i + 1}` }],
    })),
  },
  {
    id: "ch6",
    ...
    panels: Array.from({ length: 80 }, (_, i) => ({
      ...
      parts: [{ type: "caption" as const, text: `Chapter 6, Panel ${i + 1}` }],
    })),
  },
  {
    id: "ch7",
    ...
    panels: Array.from({ length: 50 }, (_, i) => ({
      ...
      parts: [{ type: "caption" as const, text: `Chapter 7, Panel ${i + 1}` }],
    })),
  },
];
